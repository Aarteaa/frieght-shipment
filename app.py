...
with tabs[0]:
    section_eyebrow("01 / DATA QUALITY — READ THIS BEFORE TRUSTING ANYTHING ELSE")
...
with tabs[1]:
    section_eyebrow("02 / Q1 — REGIONAL ON-TIME PERFORMANCE")
...
with tabs[2]:
    section_eyebrow("03 / Q2 — FREIGHT COST vs. DISTANCE")
...
with tabs[3]:
    section_eyebrow("04 / Q3 — CUSTOMER DELAY CONCENTRATION")
...
with tabs[4]:
    section_eyebrow("05 / Q5 — LEADING INDICATOR")
